...
class FcLstmModel(BaseModel):
    ...
    def __init__(self, opt, logger=None):
        ...
        self.net_seq = torch.nn.LSTM(opt.hidden_size, opt.hidden_size, batch_first=True, num_layers=1)
        self.hidden_mul = 1
