...
cmd="python train_frame_saveallcp.py --dataset_mode=frame --model=affectnet --gpu_ids=$gpu_ids
--log_dir=./logs/affectnet --checkpoints_dir=./checkpoints/affectnet --print_freq=100
...
# bash scripts/train_affectnet.sh affectnet v+a 200000 256 1e-4 0.3 256 mse 1 6
# bash scripts/train_affectnet.sh affectnet v 200000 256 1e-4 0.3 256 mse 1 6
# bash scripts/train_affectnet.sh affectnet a 200000 256 1e-4 0.3 256 mse 1 6