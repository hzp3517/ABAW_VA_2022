...
#   ③ --transformer_pretrained，--pth_path，--residual 视情况是否加上


# bash scripts/train_transformer_lstm.sh both affectnet,vggish,wav2vec None y 1 0
# bash scripts/train_transformer_lstm.sh both affectnet,vggish,wav2vec None n 1 4

# bash scripts/train_transformer_lstm.sh both affectnet,compare,wav2vec compare y 1 3
# bash scripts/train_transformer_lstm.sh both affectnet,compare,wav2vec compare n 2 4