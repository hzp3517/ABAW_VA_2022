...
# bash scripts/train_transformer_arousal.sh affectnet,compare compare 3e-5 mse transformer sincos 1 3
# bash scripts/train_transformer_arousal.sh affectnet,compare compare 3e-5 mse transformer sincos 2 4

# bash scripts/train_transformer_arousal.sh affectnet,wav2vec None 3e-5 mse transformer sincos 1 5
# bash scripts/train_transformer_arousal.sh affectnet,wav2vec None 3e-5 mse transformer sincos 2 6

# bash scripts/train_transformer_arousal.sh affectnet_arousal_mse0637,compare None 3e-5 mse transformer sincos 1 5
# bash scripts/train_transformer_arousal.sh affectnet_arousal_mse0637,compare None 3e-5 mse transformer sincos 2 6
