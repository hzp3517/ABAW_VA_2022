...
# bash scripts/train_transformer_arousal_downsample.sh 3e-5 1 mse transformer sincos 1 5

# bash scripts/train_transformer_arousal_downsample.sh 3e-5 3 mse transformer sincos 1 7