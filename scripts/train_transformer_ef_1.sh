...
loss_weights=1
loss_type=batch_ccc
log_dir=./logs/3-24/fusion-wodprelu
checkpoints_dir=./checkpoints/3-24/fusion-wodprelu
...
cmd="python train_lyc_seed.py --dataset_mode=seq_late --model=transformer_ef_1 --gpu_ids=$gpu_ids
...
# bash scripts/train_transformer_ef_1.sh both affectnet vggish,wav2vec None fc mult 1 0
# bash scripts/train_transformer_ef_1.sh both affectnet vggish,wav2vec None fc mult 2 0
# bash scripts/train_transformer_ef_1.sh both affectnet vggish,wav2vec None fc mult 3 0
# bash scripts/train_transformer_ef_1.sh both affectnet compare,wav2vec compare fc mult 1 1
# bash scripts/train_transformer_ef_1.sh both affectnet compare,wav2vec compare fc mult 2 1
# bash scripts/train_transformer_ef_1.sh both affectnet compare,wav2vec compare fc mult 3 1
