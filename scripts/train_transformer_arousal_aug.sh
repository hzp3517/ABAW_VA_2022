...
# bash scripts/train_transformer_arousal_aug.sh affectnet,compare compare 3,5 3e-5 mse transformer sincos 1 6
# bash scripts/train_transformer_arousal_aug.sh affectnet,compare compare 3,5 3e-5 mse transformer sincos 2 7

# bash scripts/train_transformer_arousal_aug.sh affectnet,compare compare None 3e-5 mse transformer sincos 1 4
