...
if __name__ == '__main__':
    ...
    for checkpoint in checkpoints:
        ...
        # np.save(val_nosmooth_ori_pred_path, nosmooth_ori_pred)
        # np.save(val_nosmooth_pred_path, nosmooth_pred)
        # np.save(val_smooth_pred_path, smoothed_pred)
        ...
        # np.save(test_smooth_pred_path, test_smoothed_pred)