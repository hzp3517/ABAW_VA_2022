...
class SeqResplitDataset(BaseDataset):
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        parser.add_argument('--cv', type=int, help='cross validation number')
    ...
    def normalize_on_trn(self, feature_name, features):
        ...
        '''
        mean_std_file = h5py.File(os.path.join(self.root, 'features', 'resplit', 'mean_std_on_trn', feature_name + '.h5'), 'r')
    ...
    def load_label(self):
        ...
        label_path = os.path.join(self.root, 'targets/resplit/{}_s{}_valid_targets.h5'.format(set_name, self.cv))
    ...
    def load_feature(self):
        ...
        for feature_name in self.feature_set:
            ...
            set_name = 'train' if self.set_name == 'train_eval' else self.set_name
            feature_path = os.path.join(self.root, 'features/resplit/{}_s{}_{}.h5'.format(set_name, self.cv, feature_name))
