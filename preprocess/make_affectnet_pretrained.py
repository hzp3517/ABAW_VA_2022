...
gpu_id = 7
pretrained_model_file = 'affectnet_arousal_2_net_dense_mse0637.pth'
...
for set_name in set_list:
    ...
    densenet_path = os.path.join(features_dir, '{}_affectnet_arousal_mse0637.h5'.format(set_name))
    ...
    for video in tqdm(list(img_h5f.keys())):
        ...
        fts = densenet_extractor(img_list, chunk_size=64)
        video_group['fts'] = fts
