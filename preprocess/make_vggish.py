...
def get_vggish_ft(audio_root, video_id, num_frames, gpu_id):
    vggish = VggishExtractor(seg_len=1/30, step_size=1/30, device=gpu_id) #标签timestamp是30Hz
    ...
    for set_name in set_list:
        ...
        for new_video_id in tqdm(valid_video_list):
            ...
            if valid_h5f[new_video_id]['special'][()] == 0: # 没有被切
                ...
                video_ft = get_vggish_ft(audio_root, original_video, num_frames, gpu_id)
